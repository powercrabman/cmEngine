...
public:
	...
	virtual [[nodiscard]] __forceinline bool IsAway(eKeyCode inKeyCode) const abstract;
	virtual [[nodiscard]] __forceinline bool IsHold(eKeyCode inKeyCode) const abstract;
