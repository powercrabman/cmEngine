...
void CameraScript::Setup()
{
	...
	mCmr = GetOwner()->CreateComponent<cmCamera>(true, t);
	mCmr->SetupOrthographicRatio(1.f, 0.1f, 100.f);

	auto* gui = GetOwner()->CreateComponent<cmEditorComponent>(true, [this]() {GUILayout(); });
